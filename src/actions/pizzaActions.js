...
//   try {
//     const response = await axios.post(`${config.api}/api/pizzas/addpizza`, {
//       pizza,
//     });
//     console.log(response);
...
//   try {
//     const response = await axios.post(`${config.api}/api/pizzas/editpizza`, {
//       editedpizza,
//     });
//     console.log(response);
...
//   try {
//     const response = await axios.post(`${config.api}/api/pizzas/deletepizza`, {
//       pizzaid,
//     });
